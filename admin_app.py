...
@app.route('/admin')
def admin_home():
    return render_template('admin_home.html', now=datetime.datetime.now())
...
def admin_login():
    ...
    return render_template('admin_login.html', now=datetime.datetime.now())
...
def admin_signup():
    ...
    return render_template('admin_signup.html', now=datetime.datetime.now())
...
def admin_dashboard():
    ...
    return render_template('admin_dashboard.html', admin=session['admin'], now=datetime.datetime.now())
